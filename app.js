"use strict";
function checkObjectName(param) {
...
// !task 2
function checkNumberArray(param) {
    if (Array.isArray(param) && param.every((value) => typeof value === 'number')) {
        const sum = param.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
